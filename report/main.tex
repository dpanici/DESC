...
This change is reflected in the updated UML diagram (Figure \ref{fig:newUML}).
...
\begin{figure}[!h]
	...
	\caption{UML Diagram for the final implementation of DESC.} %new UML diagram here
	\label{fig:newUML}
\end{figure}
...
The equilibrium force balance errors and boundary condition errors still take roughly the same amount of time to compute (see Figure \ref{fig:compute_time_rel}), and there is certainly more room for improvement with additional rounds of profiling.
