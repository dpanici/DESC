...
%%%%%%%%%%%%%%%% Start adding sections for Final Report here %%%%%%%%%%%%%%%%%%%%%%%%%

\section{Obstacles}%Or issues or something, just things we ran into that we had to deal with
...
Another thing we learned as we worked in this workflow was the the dev branch should be used only for testing.
