...
These same tests then need to be reproduced with JAX in use to check if there are opportunities specific to their overloading of the usual NumPy operations.
